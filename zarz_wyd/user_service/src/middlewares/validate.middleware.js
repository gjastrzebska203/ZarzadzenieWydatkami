...
const validateRegister = [
  ...
  body('full_name').isString().withMessage('Imię i nazwisko są wymagane.'),
  ...
  body('role')
    .optional()
    .isIn(['admin', 'user'])
    .withMessage('Dozwolone wartości to "admin", "user".'),
];
...
const validateForgotPassword = [body('email').isEmail().withMessage('Nieprawidłowy email.')];
